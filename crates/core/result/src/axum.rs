...
impl IntoResponse for Error {
    fn into_response(self) -> axum::response::Response {
        let status = match self.error_type {
            ...
            ErrorType::ProfileIsPrivate => StatusCode::FORBIDDEN,
            ...
            ErrorType::UnknownEdition => StatusCode::BAD_REQUEST,
            ErrorType::SoftResMixedEditions => StatusCode::BAD_REQUEST,
            ErrorType::TooManySoftResRaids { .. } => StatusCode::BAD_REQUEST,
            ErrorType::SoftResLocked => StatusCode::GONE,
            ErrorType::SoftResInvalidItems => StatusCode::BAD_REQUEST,
            ErrorType::SoftResClassRestricted => StatusCode::BAD_REQUEST,
            ErrorType::SoftResItemCapReached => StatusCode::CONFLICT,
            ErrorType::SoftResRecurringEvent => StatusCode::BAD_REQUEST,
            ErrorType::SoftResEventAlreadyLinked => StatusCode::CONFLICT,
