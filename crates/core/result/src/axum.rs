...
impl IntoResponse for Error {
    fn into_response(self) -> axum::response::Response {
        let status = match self.error_type {
            ...
            ErrorType::UploadSessionConflict => StatusCode::CONFLICT,
            ErrorType::UploadIncomplete => StatusCode::BAD_REQUEST,
            ErrorType::TooManyUploadSessions { .. } => StatusCode::TOO_MANY_REQUESTS,
