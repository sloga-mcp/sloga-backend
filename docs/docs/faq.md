...
<details>
  ...
  Acutest is entirely funded through donations, we have amassed a significant amount of money from donations alone. (financial transparency reports coming soon :tm:)

  The month-to-month income of Acutest covers our operational costs and leaves enough spare to cover yearly expenses and the occassional one-time expense, such as for additional hardware.
...
<details>
  <summary>Does Acutest have federation?</summary>

  As of right now, Acutest does not feature any federation and **it is not in our feature roadmap**.
...
<details>
  <summary>What can I do with Acutest and how do I self-host?</summary>

  In general:
  - The Acutest branding is used to represent the platform, stoat.chat.
  - You may use the branding as-is to promote the platform and your community on the platform.
  - You should not use the branding in order to appear as if you are associated with the Acutest team.
  - Please make explicit distinctions between Acutest (the platform, "stoat.chat") and the Acutest software.
  - The Acutest software is provided unbranded and only associated by name.
  ...
  - You **must not** appear to associate with Acutest / stoat.chat unless if granted explicit written permission. In regards to custom clients, provide a warning of any potential risks or clear it with us.
  - You **may not** use any of the Acutest branding or brand assets to advertise or promote your third party instance.

  You can self-host Acutest by:
...
For questions about the Acutest platform, you may want to go to our knowledge base:

- [What badges can I get?](https://support.stoat.chat/kb/account/badges)
- [How old do I have to be to use Acutest?](https://support.stoat.chat/kb/safety/minimum-age-guidelines)
