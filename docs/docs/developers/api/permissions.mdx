...
Acutest's permission system works by sequentially applying allows then denies.
...
If you are looking to implement permissions in a library, I highly recommend reading either the Acutest JavaScript SDK or the backend source code since all the routines are well commented and should be relatively easy to understand.
