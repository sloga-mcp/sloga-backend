...
**Status:** Stages 0–5 IMPLEMENTED and committed (backend `acutest` 6f90d6d0..26284f3d, frontend `main` 355cfcda); §12 amendments applied. Remaining: release deploy + the §9 live-smoke checklist.
